    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#2a2222] to-[#7e6d6d]">
      <div className="bg-[#231b1b] rounded-3xl shadow-2xl w-full max-w-sm p-8 flex flex-col items-center">
        ...
        <form className="w-full flex flex-col gap-5">
          <label className="text-[#e7dacb] text-lg font-rosarivo font-medium mb-1">Register</label>
          <input
            type="text"
            placeholder="Email"
          ...
          <button
            type="submit"
            className="w-full bg-[#f5ede3] text-[#231b1b] font-rosario font-semibold rounded-md py-2 mt-2 hover:bg-[#e7dacb] transition"
          >
            SIGN UP
          </button>
        </form>
